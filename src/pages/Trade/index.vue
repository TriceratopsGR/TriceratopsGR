...
export default {
  ...
  methods: {
    ...
    // 修改默认地址
    // 排他方法 当前点击的行  总数据
    changeDefault(params, list) {
      // 全部的isDefault为零
      list.forEach((tiem) => (tiem.isDefault = 0));
      params.isDefault = 1;
    },
  },
};
